$(document).ready(function(){
	...
	$('#create-course').click(function(event) {
		...
		xhr.open('POST', 'server/course.php', true);
		xhr.send(fd);
	});
...
function appendButton(){
	$(".subtitle").append("<a href='#create-course-box' class='create-course-window'>Create Course</a> ");
	...
	$.ajax({
		...
		success: function(data){
			...
			$(data).find("mycourse").each(function(){
				...
				thtml = thtml + "<div id = 'my-course-text'><a href=''><h3>" + $(this).find("title").text() + "<br/></h3></a>";
